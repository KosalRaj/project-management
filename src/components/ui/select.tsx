    ...
    <SelectPrimitive.Portal {...portalProps}>
      ...
      >
        <SelectPrimitive.Popup
          className="origin-(--transform-origin) text-foreground outline-none transition-[transform,opacity] duration-200 data-starting-style:scale-[var(--dropdown-pre-scale,0.97)] data-starting-style:opacity-0 data-ending-style:scale-[var(--dropdown-closing-scale,0.99)] data-ending-style:opacity-0 will-change-transform"
