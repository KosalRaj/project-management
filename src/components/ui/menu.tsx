  ...
  return (
    <MenuPortal {...portalProps}>
      ...
      >
        <MenuPrimitive.Popup
          className={cn(
            "relative flex not-[class*='w-']:min-w-32 origin-(--transform-origin) rounded-lg border bg-popover not-dark:bg-clip-padding shadow-lg/5 outline-none transition-[transform,opacity] duration-200 data-starting-style:scale-[var(--dropdown-pre-scale,0.97)] data-starting-style:opacity-0 data-ending-style:scale-[var(--dropdown-closing-scale,0.99)] data-ending-style:opacity-0 will-change-transform before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] focus:outline-none dark:before:shadow-[0_-1px_--theme(--color-white/6%)]",
            className,
          )}
